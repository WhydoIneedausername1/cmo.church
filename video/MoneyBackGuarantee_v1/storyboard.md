...
| 3–6s | **Mechanism, beat 1.** Hard cut to white background. Bold Inter headline center-frame: "Most lead magnets aren't good enough." Small red "X" icon accent (existing site pattern, `text-red-500` circle-x). Quick cut mid-beat (t≈4.5s) to mint (`#D0F6EC`) panel: "We build your 10/10 lead magnet." with a green checkmark accent (`#358D72`). | VO: "Most lead magnets aren't good enough. So we build your 10 out of 10 lead magnet." | Captions burned in, matching VO, split across the two sub-beats | HyperFrames kinetic type |
| 6–9s | **Proof / stat.** Teal background. Large animated stat counts up: "$0" → "$3" with label beneath in Roboto: "COST PER LEAD." Accent color (`#358D72`) underline draws in under the "$3." | VO: "Then we run Meta ads that get your cost per lead under three dollars." | "COST PER LEAD: UNDER $3" | HyperFrames stat motion |
| 9–11s | **Mechanism, beat 2 / handoff.** White background, simple line-icon (users/handoff, matches site's existing lucide-users icon style) animates in, teal color. Headline: "Leads go straight to your team." | VO: "Every lead goes straight to your team." | "Leads → Straight To Your Team" | HyperFrames kinetic type |
